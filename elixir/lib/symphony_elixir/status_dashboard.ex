defmodule SymphonyElixir.StatusDashboard do
  ...
  defp tracker_project_url(%{kind: "jira", url: url, board_id: board_id})
       when is_binary(url) and is_binary(board_id) do
    String.trim_trailing(url, "/") <> "/jira/software/c/projects/_/boards/" <> board_id
  end
